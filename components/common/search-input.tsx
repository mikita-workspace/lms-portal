...
export const SearchInput = () => {
  ...
  return (
    <div className="relative">
      ...
      <Input
        className="w-full md:w-[300px] pl-9 pr-9 rounded-lg bg-neutral-100 dark:bg-neutral-900 focus-visible:ring-neutral-200 dark:focus-visible:ring-neutral-900/40"
